...
public class QueryController {
	...
	/*
	 * @RequestMapping("queryForm.qry") //@ModelAttribute("query") public String
	 * getQueryForm(Model model) { // Define Commond Object
	 * System.out.println("In getQueryForm"); Query query = new Query();
	 * model.addAttribute("query",query); return "query/QueryPage"; }
	 */
